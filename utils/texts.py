...
TEXTS: Dict[str, str] = {
    ...
    # dashboard / status
    "status_title": "👋 **Ваши устройства и статус доступа**",
    "status_body": (
        "Здесь можно проверить, какие устройства подключены и как работает подписка.\n\n"
        "📟 **Подключения:** {connections}\n"
        "⏱ **Доступ активен:** {active_for}\n"
    ...
    "sub_list": (
        ...
        "• Минимальной цене — всего 3 ₽ в день 🔥"
    ),
    "sub_footer": (
